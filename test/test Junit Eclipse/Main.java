...
class Main {
  ...
  // aller à gaucher, [4] touche option en jeu, [5] touche interagir
  ...
  // relatif au joueur
  static String[] itemsPossédés = new String[itemsAchetables.length + 3]; // Ethan
